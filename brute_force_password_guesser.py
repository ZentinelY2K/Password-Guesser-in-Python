...
password = "1234567" #create password variable
...
while not found: #loop
    ...
    if brute_force_guesser == password: #check for congruence
        print(f"have fun getting hacked, your username: {username} your password {brute_force_guesser}") #fun statement + password
